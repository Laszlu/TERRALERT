...
export const STORM_ICON_PATH = "src/assets/images/hurricane.png";
export const STORM_ICON_SIZE = "100px";
export const EMPTY_ICON_PATH = "src/assets/images/Empty.png";
export const VOLCANOE_ICON_PATH = "src/assets/images/volcanoe.png";
export const WILDFIRE_ICON_PATH = "src/assets/images/forestfire.png";
export const FLOOD_ICON_PATH = "src/assets/images/flood.png";
export const LANDSLIDE_ICON_PATH = "src/assets/images/landslide.png";
export const EARTHQUAKE_ICON_PATH = "src/assets/images/earthquake.png";
export const TEMPERATURE_ICON_PATH = "src/assets/images/temperature.png";
